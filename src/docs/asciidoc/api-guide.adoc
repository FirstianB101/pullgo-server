...
operation::academy-list-example[snippets='curl-request,http-response']
...
operation::teacher-list-example[snippets='curl-request,http-response']
...
operation::student-list-example[snippets='curl-request,http-response']
...
operation::classroom-list-example[snippets='curl-request,http-response']
...
operation::lesson-list-example[snippets='curl-request,http-response']
...
operation::exam-list-example[snippets='curl-request,http-response']
...
operation::question-list-example[snippets='curl-request,http-response']
